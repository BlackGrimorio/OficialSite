...
<head>
    ...
    <style>
        ...
        body {
            ...
            line-height: 1.6;
            background-image: url('https://via.placeholder.com/1920x1080?text=Imagem+de+Fundo+do+Jogo'); /* Substitua pelo URL da sua imagem de fundo */
...
<body>
    ...
    <main>
        <section class="hero">
            ...
            <a href="#jogar" class="btn">Jogue Agora!</a>
        </section>
        ...
        <div class="content">
            ...
            <section id="jogar" class="section">
                <h2>Jogue Black Grimório</h2>
                <p style="text-align: center;">O Black Grimório está disponível no Roblox. Jogue agora e comece sua jornada!</p>
                <div class="button-group">
                    <a href="#" class="btn">Jogue no Roblox</a>
                    <a href="https://discord.gg/A7TaW4aaDJ" class="btn">Entrem para a família</a>
                </div>
            </section>
        </div>
    </main>
